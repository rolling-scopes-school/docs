...
- если вы уверены, что проверяющий вашу работу студент безосновательно или специально занизил баллы за выполненное задание, можете подать жалобу на такого проверяющего в [специальной форме](https://forms.gle/7ubqHfhip3H3fvjU6).ы
...
Для удобства проверки всех необходимых критериев и учета (подсчета) итоговой оценки, для каждого задания существуют специальный формы, с помощью которых можно:
...
2. Создаём новый issue [github.com/rolling-scopes-school/support/issues](https://github.com/rolling-scopes-school/support/issues). Называем его по шаблону: Cross-Check 'название таска' - 'Ваше имя на Github'.
