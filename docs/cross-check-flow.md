...
- Не используйте жалобы в качестве аргументов в защиту своей позиции и для давления на студентов.
...
Жалобы, поданные до окончания кросс-чека или заполненные некорректно, рассматриваться не будут. За угрозы жалобой студентам или за необоснованную подачу жалобы можно получить предупреждение.
