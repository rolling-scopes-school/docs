...
Для этого необходимо зайти в https://app.rs.school/ и перейти по ссылке “Cross-Check: Submit”. Далее в форме, в зависимости от задания, необходимо указать ссылку на работающий и задеплоеный сайт или ссылку на исходный код/репозиторий в GitHub.
