...
Для этого необходимо зайти в [app.rs.school](https://app.rs.school/) и перейти по ссылке `Cross-Check: Submit`. Далее в форме, в зависимости от требований задания, необходимо указать или ссылку на работающий и задеплоенный сайт, или ссылку на исходный код/репозиторий в GitHub.
