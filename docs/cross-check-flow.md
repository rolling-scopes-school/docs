...
### Жалоба
- Производится только при наличии свободного времени у администраторов и RSS-AI.
- Производится только после завершения кросс-чека.
...
2. Заполняем форму для жалоб, где обязательно указываем:
    ...
    - Скриншот комментария проверяющего.
    - Ваш комментарий по жалобе и скриншоты переписки с обсуждением оценки в разделе кросс-чека или личных сообщениях (если есть).
