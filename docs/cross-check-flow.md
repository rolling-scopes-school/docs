...
Если вы **не проверили** работы других студентов которые были распределены вам или проверили **не все из них** до наступления дедлайна по кроссчеку, то ваша оценка будет **0 баллов**.
