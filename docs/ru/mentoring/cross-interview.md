...
- **Закреплять теорию через проговаривание.**  
  ...
  в «я могу это сформулировать и защитить».
...
3. **Кросс‑интервью между студентами** (формат этого документа).
4. **Интервью с ментором** по тем же темам (CoreJS / course interview и т.п.).
...
### 4.2. Проведение сессии (вариант для одной группы)
