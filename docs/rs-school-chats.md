...
* Ваш ник в Discord должен содержать название вашего GitHub аккаунта в формате `nickname(@GitHubAccount)`. Например, вот так - `Paval Miatlitski (@pavalEscoba)`. Данное правило касается **всех** студентов. Менторы, тренеры и администраторы могут не указывать свой GitHub account. Инструкция по добавлению аккаунта GitHub в Discord:
