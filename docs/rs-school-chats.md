...
6. Необходимо получить в #role-assigner роль текущего курса - это позволит вам просматривать релевантные чаты (отписаться от роли можно повторным нажатием на неё).
