...
Иначе рекомендуется использовать дефис для разделения всех слов в селекторе и нижний регистр.
...
Такие имена проще понять и, скорее всего, не придется менять в будущем.

Шаблонные имена — это просто варианты названий для элементов, у которых нет специального предназначения или которые не отличаются от своих братьев и сестер. Обычно они необходимы в качестве “Помощников”.
...
К тому же, возможно, в будущем вы захотите изменить используемый тег на какой-то другой. В этом случае,
вам придется найти все места с использованием данного тега в стилях и заменить его,
