...
Количество студентов зависит от количества менторов.
Для примера возьмем набор RSSchool 2019Q1. В этом наборе 158 человек записалось в менторы и мы смогли пригласить на собеседование TOP810 студентов, из которых 510 продолжили обучение во втором этапе.
...
## Что делать, если вы неуспешно прошли собеседование
Вы можете продолжить обучение самостоятельно или записаться на следующий набор. Лекции, задания и чаты находятся в публичном доступе. Ваши задания не будут проверяться ментором.  
