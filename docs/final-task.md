...
- ссылку на свой GitHub
- никнейм в Discord
- позиция в Score
- (опционально) ссылки на Github профили студентов, с которыми он хотел бы оказаться в одной группе
...
1. Активные студенты курса регистрируются в созданной для этой цели форме, тем самым подтверждая своё желание и готовность участвовать в выполнении курсового проекта.
...
1. Для распределения задач, установки промежуточных дедлайнов, понимания каждым хода разработки (кто, где и на какой стадии находится) используются таск-трекеры: Projects текущего GitHub репозитория или Trello.

2. В канале work-status (еще лучше - в формате еженедельного митинга) каждый участник команды (в том числе Тим лид) каждый день составляют мини-отчёты по схеме:
