...
### Я не могу замержить Pull Request из ветки разработки в ветку gh-pages, что делать?
...
- Зайдите в настройки(settings) приватного репозитория и проверьте/выставите нужну ветку для деплоя: `gh-pages /root`
