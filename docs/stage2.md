...
4. Ментор проверяет PR, оставляет свои замечания, рекомендации, указывает предварительную оценку в комментарии. 
    - Оценка выставляется ментором на основании критериев оценки указанных для каждого задания. 
    - Предварительная оценка выставляется ментором авансом, с учетом того, что студент исправит все замечания ментора.
