...
- Большинство заданий после их выполнения необходимо сабмитуть в RS APP **до дедлайна**:
  ...
  - Если вы не успели засабмитать к дедлайну и таск относится к категориям "Cross-check", "CodeJam" и не подразумевает проверку кода ментором - вы получаете 0. Пример таких заданий - Lodash Quick Draw, Websocket Challenge, etc.
